...
public class RandomUtils {
     ...
     * @param length
     * @return
     * @see com.idoukou.thu.utils.RandomUtils#getRandom(String source, int length)
     */
     ...
     * <li>else see {@link com.idoukou.thu.utils.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     * </ul>
     */
